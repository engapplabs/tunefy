 ...
 *
 * In case where user send a resource through internet
 * and want to create a temporary file using its bytes
 * just use getTemporaryFileFromBytes method.
 *
...
public class ResourceStreamUtil {
    ...
    /**
     * It gets a resource as byte array to build a
     * temporary file and returns it.
     *
     * @param resourceBytes
     * @param prefixName
     * @param extension
     ...
     */
    public File getTemporaryFileFromBytes(byte[] resourceBytes,
                                          String prefixName, String extension) {
        try {
            File file =   File.createTempFile(prefixName, extension, null);
